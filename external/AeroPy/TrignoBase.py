...
# --- START FIX ---
# Calculate the absolute path to the 'resources' directory
# This assumes 'resources' is located in the root 'LETREP25-26-1' folder or inside 'project'
current_file_dir = os.path.dirname(__file__)   # .../project/AeroPy
project_dir = os.path.dirname(current_file_dir) # .../project
root_dir = os.path.dirname(project_dir)         # .../LETREP25-26-1

# Check where the resources folder is and add it to sys.path
...
if os.path.exists(resources_path):
    ...
    print(f"WARNING: Could not find 'resources' folder in {root_dir} or {project_dir}")

# Now add the reference by name only (without the folder path)
try:
