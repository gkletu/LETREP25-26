...
class ParticipantLoginPopup:
    ...
    def _show_number_pad_popup(self):
        ...
        display_container = tk.Frame(self.popup, bg=COLORS['bg_main'])
        display_container.pack(pady=10)

        # SUNKEN display box
        display_frame = tk.Frame(display_container, relief=tk.RAISED, borderwidth=2, bg=COLORS['bg_raised'])
        ...
        entry_display.pack(padx=20, pady=20)
        ...
        self._create_entry_type_selection()
        self._create_number_pad()

    def _create_number_pad(self):
        numpad_frame = tk.Frame(self.popup, bg=COLORS['bg_main'])
        ...
        for i in range(9):
            ...
            tk.Button(
                ...
                width=5, height=2,
                bg=COLORS['numpad_btn'],
                activebackground=COLORS['numpad_active'],
                fg=COLORS['text_numpad'],
                relief=tk.RAISED,
                bd=2,
    ...
    def _create_entry_type_selection(self):
        frame = tk.Frame(self.popup, bg=COLORS['bg_main'])
        frame.pack(pady=5)
